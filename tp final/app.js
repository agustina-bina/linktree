...
const mascotas = [
  ...
  },
  {
    ...
    necesidadesEspeciales: false,
    descripcion:
      "Uli es un gato independiente pero muy dulce. Disfruta de la tranquilidad y los momentos de caricias.",
...
function calcularDonacion() {
  ...
  Swal.fire({
    ...
    text: `Con $${amount} tu donación tendrá un gran impacto en Pichis Rescue`,
    confirmButtonColor: "#FF8C42",
  })
}
